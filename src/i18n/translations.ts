...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    formalInvitation: {
      ...
      groomFamilyLine: "(Grandson of Shri Ashok Srivastava & Late Smt. Subhashini Srivastava)",
      groomParents: "(Son of Smt. Garima & Shri Subodh Srivastava, Brother of Parv Srivastava)",
      conjunction: "with",
      brideName: "Shreya",
      brideParents: "(Daughter of Smt. Archana & Dr. Rajesh Joshi)",
      invitation:
