  ...
  en: {
    ...
    events: {
      mehandi: {
        ...
        time: "2:00 PM",
        date: "11th December",
        tagline: "Henna-dark hands, and a love just beginning.",
      },
      "engagement-sangeet": {
        name: "What Thumka",
        time: "6:30 PM",
        date: "11th December",
        tagline: "Music, laughter, and a promise set to dance.",
      },
      masquerade: {
        name: "Masque-Era",
        time: "10:30 PM",
        date: "11th December",
        tagline: "Behind every mask, the same happy hearts.",
      },
      haldi: {
        name: "Kesariya Khwaab",
        time: "10:30 AM",
        date: "12th December",
        tagline: "Sunshine on her skin, laughter in the air.",
      },
      baarat: {
        name: "Baarat",
        time: "4:00 PM",
        date: "12th December",
        tagline: "Dhol, dance, and a groom on his way.",
      },
      varmala: {
        name: "Suraj Hua Maddham",
        time: "5:30 PM",
        date: "12th December",
        tagline: "Two hearts, two families, two garlands.",
      },
      fera: {
        name: "Taaron ki Chhanv",
        time: "11:00 PM",
        date: "12th December",
        tagline: "Seven vows, forever — taaron ki chhaon mein.",
      },
    },
  },
  hi: {
    ...
    events: {
      mehandi: {
        ...
        time: "दोपहर २:००",
        date: "११ दिसंबर",
        tagline: "रचे हाथ, और एक नया-नया प्यार।",
      },
      "engagement-sangeet": {
        name: "व्हाट ठुमका",
        time: "शाम ६:३०",
        date: "११ दिसंबर",
        tagline: "संगीत, हँसी और थिरकते हुए वादे।",
      },
      masquerade: {
        name: "मास्क-एरा",
        time: "रात १०:३०",
        date: "११ दिसंबर",
        tagline: "हर नक़ाब के पीछे वही ख़ुश दिल।",
      },
      haldi: {
        name: "केसरिया ख़्वाब",
        time: "सुबह १०:३०",
        date: "१२ दिसंबर",
        tagline: "धूप-सी हल्दी, हवा में गूँजती हँसी।",
      },
      baarat: {
        name: "बारात",
        time: "शाम ४:००",
        date: "१२ दिसंबर",
        tagline: "ढोल, नाच और आता हुआ दूल्हा।",
      },
      varmala: {
        name: "सूरज हुआ मद्धम",
        time: "शाम ५:३०",
        date: "१२ दिसंबर",
        tagline: "दो दिल, दो परिवार, एक वरमाला।",
      },
      fera: {
        name: "तारों की छाँव",
        time: "रात ११:००",
        date: "१२ दिसंबर",
        tagline: "सात वचन, सदा के लिए — तारों की छाँव में।",
      },
    },
  },
  gu: {
    ...
    events: {
      mehandi: {
        ...
        time: "બપોરે ૨:૦૦",
        date: "૧૧ ડિસેમ્બર",
        tagline: "મહેંદીભર્યા હાથ, અને નવો-નવો પ્રેમ.",
      },
      "engagement-sangeet": {
        name: "વોટ ઠુમકા",
        time: "સાંજે ૬:૩૦",
        date: "૧૧ ડિસેમ્બર",
        tagline: "સંગીત, હાસ્ય અને નાચતું વચન.",
      },
      masquerade: {
        name: "માસ્ક-એરા",
        time: "રાત્રે ૧૦:૩૦",
        date: "૧૧ ડિસેમ્બર",
        tagline: "દરેક મુખવટા પાછળ એ જ ખુશ હૃદય.",
      },
      haldi: {
        name: "કેસરિયા ખ્વાબ",
        time: "સવારે ૧૦:૩૦",
        date: "૧૨ ડિસેમ્બર",
        tagline: "હળદરનો તડકો, હવામાં હાસ્ય.",
      },
      baarat: {
        name: "બારાત",
        time: "સાંજે ૪:૦૦",
        date: "૧૨ ડિસેમ્બર",
        tagline: "ઢોલ, નાચ અને આવતો વરરાજા.",
      },
      varmala: {
        name: "સૂરજ હુઆ મદ્ધમ",
        time: "સાંજે ૫:૩૦",
        date: "૧૨ ડિસેમ્બર",
        tagline: "બે હૃદય, બે પરિવાર, એક વરમાળા.",
      },
      fera: {
        name: "તારોં કી છાંવ",
        time: "રાત્રે ૧૧:૦૦",
        date: "૧૨ ડિસેમ્બર",
        tagline: "સાત વચન, સદાય — તારાઓની છાંવમાં.",
      },
    },
  },
};
