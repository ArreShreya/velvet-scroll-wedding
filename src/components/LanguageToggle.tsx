...
export function LanguageToggle() {
  ...
  return (
    <div
      ...
      className="pointer-events-auto flex items-center gap-0.5 rounded-full border border-rose/60 bg-paper-tint/85 p-0.5 shadow-[0_6px_18px_-12px_rgba(90,50,40,0.6)] backdrop-blur-sm"
    >
      {LANGS.map((l) => (
        <button
          key={l.code}
